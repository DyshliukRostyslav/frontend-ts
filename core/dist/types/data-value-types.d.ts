...
export declare const isLookupDataValueType: (dataValueType: DataValueType) => boolean;
export declare const isDateDataValueType: (dataValueType: DataValueType) => boolean;
